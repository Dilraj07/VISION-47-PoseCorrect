"""Shoulder Press Analyzer - Enhanced with CV pipeline"""
import cv2
...
def analyze_shoulder_press_video(video_path, output_path=None):
    ...
    # Carry-forward state
    last_good_metrics = {k: None for k in ['left_elbow', 'right_elbow', 'left_shoulder_angle', 'right_shoulder_angle', 'left_wrist_y', 'right_wrist_y', 'shoulder_y']}
        ...
        while cap.isOpened():
            ...
            if results.pose_landmarks:
                ...
                if current_elbow is not None:
                    # ===== Velocity tracking =====
                    vel_data = velocity_tracker.update(current_elbow)
            ...
            final_image = add_info_panel(image_rgb, frame_count, total_frames, fps, rep_count, max_elbow_angle, last_velocity_str)
